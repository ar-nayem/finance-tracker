...
INSERT INTO "new_Account" ("createdAt", "currency", "id", "name", "role", "type", "userId") SELECT "createdAt", "currency", "id", "name", "role", "type", "userId" FROM "Account";
DROP TABLE "Account";
...
INSERT INTO "new_Document" ("createdAt", "fileName", "filePath", "fileSize", "id", "mimeType", "userId") SELECT "createdAt", "fileName", "filePath", "fileSize", "id", "mimeType", "userId" FROM "Document";
DROP TABLE "Document";
...
INSERT INTO "new_Investment" ("accountId", "amount", "createdAt", "currency", "date", "documentId", "id", "name", "notes", "status", "type", "userId") SELECT "accountId", "amount", "createdAt", "currency", "date", "documentId", "id", "name", "notes", "status", "type", "userId" FROM "Investment";
...
INSERT INTO "new_Stream" ("createdAt", "currency", "id", "name", "userId") SELECT "createdAt", "currency", "id", "name", "userId" FROM "Stream";
DROP TABLE "Stream";
...
INSERT INTO "new_Transaction" ("accountId", "amount", "category", "createdAt", "currency", "date", "documentId", "id", "note", "streamId", "type", "userId") SELECT "accountId", "amount", "category", "createdAt", "currency", "date", "documentId", "id", "note", "streamId", "type", "userId" FROM "Transaction";
...
INSERT INTO "new_Transfer" ("createdAt", "date", "fromAccountId", "fromAmount", "fromCurrency", "id", "note", "toAccountId", "toAmount", "toCurrency", "userId") SELECT "createdAt", "date", "fromAccountId", "fromAmount", "fromCurrency", "id", "note", "toAccountId", "toAmount", "toCurrency", "userId" FROM "Transfer";
DROP TABLE "Transfer";
